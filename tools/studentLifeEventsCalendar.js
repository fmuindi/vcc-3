...
const STUDENT_LIFE_EVENTS_CALENDAR_BODY = `  <section id="calendar-hero" style="position:relative;min-height:56vh;display:flex;align-items:center;overflow:hidden;background:#100E0D;padding-top:110px">
  ...
  <section id="featured-event" style="max-width:1320px;margin:0 auto;padding:80px 32px 0">
    <div data-reveal="" style="position:relative;border-radius:24px;overflow:hidden;min-height:340px;display:flex;align-items:flex-end;box-shadow:0 30px 70px rgba(16,14,13,.2)">
      <img src="${IMG.studentLifeGallery[3]}" alt="Valor Christian College campus" loading="eager" decoding="async" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover">
      <div style="position:absolute;inset:0;background:linear-gradient(0deg,rgba(16,14,13,.92) 10%,rgba(16,14,13,.15) 70%)"></div>
      <div style="position:relative;padding:40px 44px;max-width:640px">
        <div style="font-size:11px;font-weight:800;letter-spacing:.2em;text-transform:uppercase;color:#FF8A93;margin-bottom:14px">Featured Event</div>
        <h2 style="margin:0 0 10px;font-family:'Bricolage Grotesque',sans-serif;font-weight:800;font-size:clamp(26px,3.4vw,40px);line-height:1.05;letter-spacing:-.03em;color:#FAF5EE">VIP Weekend 2027</h2>
        <div style="font-size:14px;font-weight:700;color:rgba(250,245,238,.85);margin-bottom:16px">April 2027 &middot; exact dates to be announced</div>
        <p style="margin:0 0 24px;font-size:15.5px;line-height:1.6;color:rgba(250,245,238,.82);max-width:52ch">A weekend designed to experience Valor, connect with our community, and see what life as a World Changer could look like.</p>
