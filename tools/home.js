  ...
  <section data-reveal="" style="position:relative;margin-top:40px;padding:120px 32px;background:#100E0D;overflow:hidden">
    ...
    <div style="position:relative;max-width:1000px;margin:0 auto">
      <div class="quote-stage">
        ...
        <blockquote class="quote-slide" style="margin:0;text-align:center">
          <div style="font-family:'Bricolage Grotesque',sans-serif;font-weight:800;font-size:clamp(28px,3.8vw,54px);line-height:1.12;letter-spacing:-.02em;color:#FAF5EE;text-wrap:balance">"Only one life will soon be past. Only what's done for <span style="color:#E01B2E">Christ</span> will last."</div>
          <footer style="margin-top:26px;font-size:12px;font-weight:700;letter-spacing:.18em;text-transform:uppercase;color:rgba(250,245,238,.6)">Dr. Rob Starner · Professor of New Testament</footer>
        </blockquote>
        <blockquote class="quote-slide" style="margin:0;text-align:center">
          <div style="font-family:'Bricolage Grotesque',sans-serif;font-weight:800;font-size:clamp(22px,3vw,40px);line-height:1.22;letter-spacing:-.02em;color:#FAF5EE;text-wrap:balance">"I believe Valor Christian College is positioned to be one of the most <span style="color:#E01B2E">significant colleges in the world</span> at sending powerful men and women into the ministry. And I am thrilled to be here!"</div>
          <footer style="margin-top:26px;font-size:12px;font-weight:700;letter-spacing:.18em;text-transform:uppercase;color:rgba(250,245,238,.6)">Dr. Richard Hogue · Professor of Church History and Theology</footer>
        </blockquote>
        <blockquote class="quote-slide" style="margin:0;text-align:center">
          <div style="font-size:12px;font-weight:700;letter-spacing:.18em;text-transform:uppercase;color:#E01B2E;margin-bottom:18px">A Life Worth Making</div>
          <div style="font-family:'Bricolage Grotesque',sans-serif;font-weight:800;font-size:clamp(24px,3.2vw,44px);line-height:1.18;letter-spacing:-.02em;color:#FAF5EE;text-wrap:balance">"Life is not merely something we endure; it is something we make. Ministry gives it purpose, the arts give it <span style="color:#E01B2E">beauty</span>, and education gives it depth."</div>
          <footer style="margin-top:26px;font-size:12px;font-weight:700;letter-spacing:.18em;text-transform:uppercase;color:rgba(250,245,238,.6)">Professor Philip Tabler · Music Department Chair</footer>
        </blockquote>
        <blockquote class="quote-slide" style="margin:0;text-align:center">
          <div style="font-family:'Bricolage Grotesque',sans-serif;font-weight:800;font-size:clamp(19px,2.4vw,30px);line-height:1.3;letter-spacing:-.01em;color:#FAF5EE;text-wrap:balance">"At Valor Christian College you will receive formal theological <span style="color:#E01B2E">EDUCATION</span> combined with practical, hands-on <span style="color:#E01B2E">APPLICATION</span> and empowered by Holy Spirit <span style="color:#E01B2E">IMPARTATION</span> — all within the context of a vibrant New Testament local church. That is what sets Valor Christian College apart. Enroll today and become a <span style="color:#E01B2E">WORLD CHANGER</span>!"</div>
          <footer style="margin-top:26px;font-size:12px;font-weight:700;letter-spacing:.18em;text-transform:uppercase;color:rgba(250,245,238,.6)">Dr. Scott Camp · President</footer>
        </blockquote>
        <blockquote class="quote-slide" style="margin:0;text-align:center">
          <div style="font-family:'Bricolage Grotesque',sans-serif;font-weight:800;font-size:clamp(22px,3vw,40px);line-height:1.22;letter-spacing:-.02em;color:#FAF5EE;text-wrap:balance">"One of the essential qualities of God is that He is <span style="color:#E01B2E">omniscient</span>, or all-knowing. And we should be glad that He is, because do you really want a God that is only as smart as you are?"</div>
          <footer style="margin-top:26px;font-size:12px;font-weight:700;letter-spacing:.18em;text-transform:uppercase;color:rgba(250,245,238,.6)">Professor Mark Youngkin · Church Ministries Chair</footer>
        </blockquote>
      </div>
      <div class="quote-dots">
        ...
        <button aria-label="Show quote 4"></button>
        <button aria-label="Show quote 5"></button>
        <button aria-label="Show quote 6"></button>
        <button aria-label="Show quote 7"></button>
        <button aria-label="Show quote 8"></button>
      </div>
    </div>
  </section>
