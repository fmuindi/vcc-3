...
const BASE_STYLE = `<style>
  *{box-sizing:border-box}
  ...
  .reel-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(150px,200px));justify-content:center;gap:18px}
  .reel-item{position:relative;display:block;width:100%;aspect-ratio:9/16;border-radius:18px;overflow:hidden;background:#100E0D;box-shadow:0 14px 34px rgba(16,14,13,.2);border:0;padding:0;margin:0;font:inherit;color:inherit;cursor:pointer;transition:transform .3s ease,box-shadow .3s ease}
