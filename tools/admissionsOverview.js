...
const ADMISSIONS_OVERVIEW_BODY = `  <section id="admissions-hero" style="position:relative;min-height:82vh;display:flex;align-items:flex-end;overflow:hidden;background:#100E0D;padding-top:110px">
