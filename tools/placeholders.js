...
const PAGES = [
  ...
  { href: 'tuition-aid.html', section: 'Tuition & Aid', title: 'Financial Overview', blurb: 'A clear look at cost, aid, scholarships, veterans benefits, and who to talk to about paying for Valor.' },
  { href: 'tuition-aid-tuition-fees.html', section: 'Tuition & Aid', title: 'Tuition & Fees', blurb: 'Current tuition and fees by program.' },
  { href: 'tuition-aid-international.html', section: 'Tuition & Aid', title: 'International Student Tuition & Fees', blurb: 'Tuition and fee information for international students.' },
  ...
  { href: 'tuition-aid-veterans-benefits.html', section: 'Tuition & Aid', title: 'Veterans Benefits', blurb: 'Education benefits available to veterans and military family members.' },
  { href: 'tuition-aid-speak-with-finance.html', section: 'Tuition & Aid', title: 'Speak with the Finance Office', blurb: 'Connect directly with the Finance Office about your account.' },
  { href: 'tuition-aid-speak-with-financial-aid-counselor.html', section: 'Tuition & Aid', title: 'Speak with a Financial Aid Counselor', blurb: 'Talk through aid and scholarship options with a counselor.' },
