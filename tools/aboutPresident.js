...
const ABOUT_PRESIDENT_BODY = `  <section id="president-hero" style="position:relative;min-height:78vh;display:flex;align-items:center;overflow:hidden;background:#100E0D;padding-top:70px">
  ...
  <section id="scholarship" style="max-width:1320px;margin:100px auto 0;padding:0 32px">
    <div class="about-grid" style="position:relative;display:grid;grid-template-columns:1.15fr .85fr;gap:56px;align-items:center;background:linear-gradient(135deg,#1a0508 0%,#4a0d15 55%,#E01B2E 100%);border-radius:28px;padding:60px;overflow:hidden;box-shadow:0 30px 80px rgba(224,27,46,.28)">
      ...
      <div style="position:relative">
        <div data-reveal="" style="display:inline-flex;align-items:center;gap:9px;background:rgba(255,255,255,.14);color:#fff;font-size:11px;font-weight:700;letter-spacing:.14em;text-transform:uppercase;padding:9px 18px;border-radius:999px;margin-bottom:22px"><i class="fa-solid fa-award"></i> Dr. Scott Camp Presidential Scholarship</div>
        ...
        <a data-reveal="" href="tuition-aid-scholarships.html" style="display:inline-block;background:#fff;color:#100E0D;font-size:14px;font-weight:700;letter-spacing:.06em;text-transform:uppercase;padding:17px 30px;border-radius:999px;transition:transform .18s ease" style-hover="transform:translateY(-2px);background:#FAF5EE;color:#100E0D">Learn More About the Scholarship</a>
