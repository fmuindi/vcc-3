...
const ABOUT_LEGACY_BODY = `  <section id="legacy-hero" style="position:relative;min-height:86vh;display:flex;align-items:flex-end;overflow:hidden;background:#100E0D;padding-top:110px">
  ...
  <section id="vision" class="about-grid" style="max-width:1320px;margin:0 auto;padding:110px 32px 40px;display:grid;grid-template-columns:.95fr 1.05fr;gap:64px;align-items:center">
    <div data-reveal="" class="about-collage" style="height:560px;border-radius:20px;overflow:hidden;box-shadow:0 30px 70px rgba(16,14,13,.22)">
      <img src="https://directus.valorcollege.edu/assets/D779215E-10CE-4BE3-A11F-766783EFE79C" alt="Valor Christian College" loading="lazy" decoding="async" style="width:100%;height:100%;object-fit:cover;display:block">
    </div>
    <div>
  ...
  <section id="school-of-the-spirit" data-reveal="" style="position:relative;margin-top:60px;padding:130px 32px;background:#100E0D;overflow:hidden">
    ...
    <div style="position:relative;max-width:900px;margin:0 auto;text-align:center">
      ...
      <footer data-reveal="" style="margin:22px 0 0;font-size:12px;font-weight:700;letter-spacing:.18em;text-transform:uppercase;color:rgba(250,245,238,.6)">— Dr. Rod Parsley, Founder &amp; Chancellor</footer>
    </div>
  </section>
  ...
  <section id="then-now-next" style="max-width:1320px;margin:0 auto;padding:40px 32px 100px">
    ...
    <div class="programs-grid" style="display:grid;grid-template-columns:repeat(3,1fr);gap:18px">
      ...
      <div data-reveal="" style="position:relative;height:480px;border-radius:20px;overflow:hidden;color:#fff">
        <img src="https://directus.valorcollege.edu/assets/AD89E786-5B79-4BB7-8072-CA3161652397" alt="Students in worship at Valor" loading="lazy" decoding="async" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover">
        <div style="position:absolute;inset:0;background:linear-gradient(0deg,rgba(16,14,13,.96) 20%,rgba(16,14,13,.15) 78%)"></div>
        <div style="position:absolute;left:24px;right:24px;bottom:20px;height:200px;display:flex;flex-direction:column;justify-content:flex-start">
          ...
          <p style="margin:0;font-size:14px;line-height:1.55;color:rgba(250,245,238,.8)">Students from different backgrounds and places come to Valor to learn, worship, serve, and discover who God has called them to become.</p>
        </div>
      </div>
      <div data-reveal="" style="position:relative;height:480px;border-radius:20px;overflow:hidden;color:#fff">
        <img src="https://directus.valorcollege.edu/assets/A75532CA-AA46-401E-B355-02CB2CBD270D" alt="Valor students serving" loading="lazy" decoding="async" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover">
        <div style="position:absolute;inset:0;background:linear-gradient(0deg,rgba(16,14,13,.96) 20%,rgba(16,14,13,.15) 78%)"></div>
        <div style="position:absolute;left:24px;right:24px;bottom:20px;height:200px;display:flex;flex-direction:column;justify-content:flex-start">
