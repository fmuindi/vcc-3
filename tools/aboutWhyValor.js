  ...
  <section id="why-valor-cta" style="position:relative;margin-top:0;background:#E01B2E;color:#fff;padding:110px 32px;overflow:hidden">
    ...
    <div style="position:relative;max-width:1000px;margin:0 auto;text-align:center">
      ...
      <div class="help-cta-buttons" style="display:flex;flex-wrap:wrap;gap:14px;justify-content:center">
        <a data-reveal="" href="mailto:admissions@valorcollege.edu" style="border:1.5px solid rgba(255,255,255,.6);color:#fff;font-size:15px;font-weight:600;letter-spacing:.06em;text-transform:uppercase;padding:19px 32px;border-radius:999px;transition:background .18s ease" style-hover="background:rgba(255,255,255,.16);color:#fff">Request Info</a>
